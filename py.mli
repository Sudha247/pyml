...
module Iter: sig
  ...
  val of_seq: Object.t Stdlib.Seq.t -> Object.t
  (** [of_seq s] returns an interator that iterates over the values of the
      sequence [s]. *)

  val of_seq_map: ('a -> Object.t) -> 'a Stdlib.Seq.t -> Object.t
  ...
  val to_seq: Object.t -> Object.t Stdlib.Seq.t
  ...
  val to_seq_map: (Object.t -> 'a) -> Object.t -> 'a Stdlib.Seq.t
  (** [to_seq_map f i] returns the sequence of the results of [f] applied to the
      values from the iteration [i].
      The Python iteration is consumed while the sequence is browsed.
      Values are memoized, so that the sequence can be browsed many times. *)

  val unsafe_to_seq: Object.t -> Object.t Stdlib.Seq.t
  ...
  val unsafe_to_seq_map: (Object.t -> 'a) -> Object.t -> 'a Stdlib.Seq.t
...
module List: sig
  ...
  val to_seqi: Object.t -> (int * Object.t) Stdlib.Seq.t
